        ...
        pointButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(process.indexOf('.')==-1 && !process.isEmpty())
                    ...
                    Toast.makeText(SimpleActivity.this,"Najpierw wprowadź liczbę",Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(SimpleActivity.this,"Możesz użyć tylko raz tego znaku dla jednej liczby",Toast.LENGTH_SHORT).show();
                }
            ...
            public void onClick(View v) {
                ...
                if(!resultTextView.getText().toString().isEmpty()) {
                    ...
                    if (resultTextView.getText().toString().equals("0")||resultTextView.getText().toString().equals("0.0")) {
                        Toast.makeText(SimpleActivity.this, "Zero nie moze byc ujemne", Toast.LENGTH_SHORT).show();
                    ...
                    switch (sign) {
                        ...
                        case '/':
                            if(Double.parseDouble(splitted[splitted.length - 1])==0){
                                Toast.makeText(SimpleActivity.this,"Nie mozna dzielic przez zero",Toast.LENGTH_SHORT).show();
